...
class _HomeState extends State<Home> {
                  ...
                  children: [
                    GestureDetector(
                      onTap: () async {
                        ...
                        XFile? img2 =
                            await pick2.pickImage(source: ImageSource.gallery);
                        setState(() {
                          path = img2!.path;
                        });
                      },
                    ...
                    child: InkWell(
                      ...
                      child: path == null
                          ? Container(
                              ...
                              alignment: Alignment.center,
                              child: const Text("+ Add Your Logo"),
                            )
                          : Container(
                              height: 215,
                              decoration: BoxDecoration(
                  ...
                  Padding(
                    ...
                    child: TextFormField(
                      ...
                      decoration: InputDecoration(
                        ...
                        border: OutlineInputBorder(
                            borderSide:
                                const BorderSide(color: Color(0xFF555259)),
                      ...
                      : Column(
                          children: item
                              ...
                              .map(
                                (e) => items(
                                    "${item[e.key]}".toString(),
                                    "${price[e.key]}".toString(),
                                    "${quantity[e.key]}".toString(),
                                    "${Total_Price[e.key]}".toString(),
                                    e.key),
                              )
                              .toList(),
                        ),
  ...
  Widget Update_Items(
      [String? txtIN, String? txtIP, String? txtIQ, int i = 0]) {
    return AlertDialog(
      shape: RoundedRectangleBorder(borderRadius: BorderRadius.circular(21)),
      content: Container(
        height: 350,
    ...
    return Padding(
      ...
      child: InkWell(
        onTap: () {
          showDialog(
            context: context,
            builder: (context) => Update_Items(txtI_Item.text = i_n,
                txtI_Price.text = i_p, txtI_Quantity.text = i_q, index),
          );
          print("Tap");
